...
# Template-ID: boxplot-raincloud
#
# Purpose:
#   Draw a flipped raincloud plot: stacked dots on one side of each
#   category and a half-violin on the other.
#
# Inputs:
...
#
# Output:
#   A PDF, PNG, or SVG raincloud plot.
#
# Dependencies:
