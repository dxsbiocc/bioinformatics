...
from mcp.rcsb.constants import (
    JSONRPC_VERSION,
...
class RcsbMcpServer:
    def __init__(self, client: RcsbClient | None = None) -> None:
        self.client = client or RcsbClient()
...
def serve_stdio(server: RcsbMcpServer | None = None) -> None:
    server = server or RcsbMcpServer()
    for line in sys.stdin:
        ...
        try:
            ...
            print(f"RCSB MCP internal error: {exc}", file=sys.stderr)
