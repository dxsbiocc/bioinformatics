#!/usr/bin/env python3
"""Stdio entrypoint for the Bioinformatics omics visualization MCP server."""
...
class VisualizationMcpServer:
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-visualization", "version": "0.1.0"},
        }
...
def serve_stdio(server: VisualizationMcpServer | None = None) -> None:
    server = server or VisualizationMcpServer()
    for line in sys.stdin:
        ...
        try:
            ...
            print(f"Visualization MCP internal error: {exc}", file=sys.stderr)
            response = internal_error_response(request_id, exc)
