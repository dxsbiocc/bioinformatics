...
from mcp.rnacentral.constants import JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSIONS, JsonObject
...
class RnaCentralMcpServer:
    def __init__(self, client: RnaCentralClient | None = None) -> None:
        self.client = client or RnaCentralClient()
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-rnacentral", "version": "0.1.0"},
        }
...
def serve_stdio(server: RnaCentralMcpServer | None = None) -> None:
    server = server or RnaCentralMcpServer()
