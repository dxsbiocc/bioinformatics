...
from mcp.biostudies.constants import JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSIONS, JsonObject
...
class BioStudiesMcpServer:
    def __init__(self, client: BioStudiesClient | None = None) -> None:
        self.client = client or BioStudiesClient()
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-biostudies", "version": "0.1.0"},
        }
...
def serve_stdio(server: BioStudiesMcpServer | None = None) -> None:
    server = server or BioStudiesMcpServer()
