...
from mcp.mgnify.constants import JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSIONS, JsonObject
from mcp.mgnify.errors import McpError, MgnifyError
from mcp.mgnify.tools import TOOL_HANDLERS, tool_definitions


class MgnifyMcpServer:
    def __init__(self, client: MgnifyClient | None = None) -> None:
        self.client = client or MgnifyClient()
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-mgnify", "version": "0.1.0"},
        }
...
def serve_stdio(server: MgnifyMcpServer | None = None) -> None:
    server = server or MgnifyMcpServer()
