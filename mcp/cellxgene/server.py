...
from mcp.cellxgene.constants import JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSIONS, JsonObject
from mcp.cellxgene.errors import CellxGeneError, McpError
from mcp.cellxgene.tools import TOOL_HANDLERS, tool_definitions


class CellxGeneMcpServer:
    def __init__(self, client: CellxGeneClient | None = None) -> None:
        self.client = client or CellxGeneClient()
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-cellxgene", "version": "0.1.0"},
        }
...
def serve_stdio(server: CellxGeneMcpServer | None = None) -> None:
    server = server or CellxGeneMcpServer()
