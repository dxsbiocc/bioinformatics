...
from mcp.kegg.constants import (
    JSONRPC_VERSION,
...
class KeggMcpServer:
    def __init__(self, client: KeggClient | None = None) -> None:
        self.client = client or KeggClient()
...
def serve_stdio(server: KeggMcpServer | None = None) -> None:
    server = server or KeggMcpServer()
