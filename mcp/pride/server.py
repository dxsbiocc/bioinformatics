...
from mcp.pride.constants import JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSIONS, JsonObject
from mcp.pride.errors import McpError, PrideError
from mcp.pride.tools import TOOL_HANDLERS, tool_definitions


class PrideMcpServer:
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-pride", "version": "0.1.0"},
        }
...
def serve_stdio(server: PrideMcpServer | None = None) -> None:
    server = server or PrideMcpServer()
