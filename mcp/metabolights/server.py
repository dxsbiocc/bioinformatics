...
from mcp.metabolights.constants import JSONRPC_VERSION, LATEST_PROTOCOL_VERSION, SUPPORTED_PROTOCOL_VERSIONS, JsonObject
...
class MetaboLightsMcpServer:
    def __init__(self, client: MetaboLightsClient | None = None) -> None:
        self.client = client or MetaboLightsClient()
    ...
    def _initialize(self, params: JsonObject) -> JsonObject:
        ...
        return {
            ...
            "serverInfo": {"name": "bioinformatics-metabolights", "version": "0.1.0"},
        }
...
def serve_stdio(server: MetaboLightsMcpServer | None = None) -> None:
    server = server or MetaboLightsMcpServer()
